...
import std;
# THIS IS THE OPTIMIZED VCL BY JOS JONKEREN TO CACHE MORE OR LESS ALL, FOR VARNISH 6
...
sub vcl_deliver {
    ...
    # Not letting browser to cache non-static files. Commented out to let browser cache all.
